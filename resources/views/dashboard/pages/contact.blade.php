                ...
                <table class="w-full whitespace-no-wrap">
                    ...
                    <tbody
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3 text-sm">Munni</td>
                            <td class="px-4 py-3 text-sm">afiamunni@gmail.com</td>
                            <td class="px-4 py-3 text-sm">015954569</td>
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3 text-sm">Afifa</td>
                            <td class="px-4 py-3 text-sm">afiamunni@gmail.com</td>
                            <td class="px-4 py-3 text-sm">015954569</td>
                            <td class="px-4 py-3 text-sm">6/10/2020</td>
                            <td class="px-4 py-3">
...
<div class="fixed inset-0 z-30 flex items-end bg-black bg-opacity-50 sm:items-center sm:justify-center hidden" id="modal">
    ...
    <div class="w-full px-6 py-4 overflow-hidden bg-white rounded-t-lg dark:bg-gray-800 sm:rounded-lg sm:m-4 sm:max-w-xl" role="dialog">
        <header class="flex justify-end">
            <button class="inline-flex items-center justify-center w-6 h-6 text-gray-400 transition-colors duration-150 rounded dark:hover:text-gray-200 hover: hover:text-gray-700" aria-label="close" id="closeModalButton1">
        ...
        <footer class="flex flex-col items-center justify-end px-6 py-3 -mx-6 -mb-4 space-y-4 sm:space-y-0 sm:space-x-6 sm:flex-row bg-gray-50 dark:bg-gray-800">
            <button id="closeModalButton2" class="w-full px-5 py-3 text-sm font-medium leading-5 text-white text-gray-700 transition-colors duration-150 border border-gray-300 rounded-lg dark:text-gray-400 sm:px-4 sm:py-2 sm:w-auto active:bg-transparent hover:border-gray-500 focus:border-gray-500 active:text-gray-500 focus:outline-none focus:shadow-outline-gray">
                Cancel
            </button>
            <a href="" id="confirmDeleteButton" class="w-full px-5 py-3 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-red-600 border border-transparent rounded-lg sm:w-auto sm:px-4 sm:py-2 active:bg-red-600 hover:bg-red-700 focus:outline-none focus:shadow-outline-red">
                Delete
            </a>
        </footer>
    </div>
...
<script>
    ...
    openModalButton.forEach(button => {
        button.addEventListener('click', function() {
            ...
            console.log(id);
            confirmDeleteButton.setAttribute('href', id);
